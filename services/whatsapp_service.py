...
class WhatsAppService:
    ...
    @staticmethod
    def _send_post_request(payload: Dict[str, Any]) -> bool:
        """
        Sends the payload to the Meta WhatsApp Business API.
        If credentials are default/mock, it simulates a successful send by logging the payload.
        """
    ...
    @classmethod
    def send_text_message(cls, to_phone: str, text: str) -> bool:
        """
        ...
        return cls._send_post_request(payload)

    @classmethod
    def send_document_message(cls, to_phone: str, document_url: str, filename: str, caption: Optional[str] = None) -> bool:
        """
    ...
    @classmethod
    def send_interactive_buttons(cls, to_phone: str, body_text: str, buttons: List[Dict[str, str]]) -> bool:
        """
